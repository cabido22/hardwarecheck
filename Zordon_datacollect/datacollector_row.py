...
# information, and generates a collect_list_row.csv file containing all elements 
...
class DataCollect:
    def __init__(self):
        ...
        self.collect_list = r"results\collect_list_row.csv"
...
# information, and generates a collect_list_row.csv file containing all key elements 
